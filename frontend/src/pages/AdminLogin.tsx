...
export default function AdminLogin({
  ...
  return (
    <div className="min-h-screen relative overflow-hidden flex flex-col items-center justify-center p-4">
      ...
      <button
        onClick={() => navigate("/")}
        className="fixed top-8 left-8 z-20 flex items-center gap-2 text-gray-700 dark:text-white/80 hover:text-red-600 dark:hover:text-white transition-all group"
      >
