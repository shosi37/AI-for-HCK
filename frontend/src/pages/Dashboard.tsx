            ...
            <div className="relative">
              ...
              >
                ...
                <div className="text-left hidden md:block">
                  <div className="text-gray-900 dark:text-white text-sm">{user.name}</div>
                  <div className="text-gray-600 dark:text-white/60 text-xs">{user.email}</div>
                </div>
        ...
        <div className="px-8 py-8 max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="glass rounded-2xl p-6 border border-gray-200 dark:border-white/10">
              ...
              <div className="text-gray-900 dark:text-white text-lg break-all">{user.email}</div>
            </div>
            ...
            <div className="glass rounded-2xl p-6 border border-gray-200 dark:border-white/10">
              ...
              <div className="text-gray-900 dark:text-white text-lg">
                User ID: {user.id ? user.id.slice(0, 8) : 'N/A'}...
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
              {user.studentId && (
                <div className="glass rounded-2xl p-6 border border-gray-200 dark:border-white/10">
                  ...
                  <div className="text-gray-900 dark:text-white text-lg">{user.studentId}</div>
                </div>
              )}
              ...
              {user.department && (
                <div className="glass rounded-2xl p-6 border border-gray-200 dark:border-white/10">
                  ...
                  <div className="text-gray-900 dark:text-white text-lg">{user.department}</div>
                </div>
              )}
              ...
              {user.year && (
                <div className="glass rounded-2xl p-6 border border-gray-200 dark:border-white/10">
                  ...
                  <div className="text-gray-900 dark:text-white text-lg">{user.year}</div>
                </div>
              )}
            </div>
          )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              >
                <div className="w-8 h-8 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center mb-3">
                  <span className="text-sm text-white">{getInitials(user.name)}</span>
                </div>
