            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div className="relative group">
                        ...
                        >
                            <option value="" className="dark:bg-[#1f2937]">Select Department</option>
                            <option value="Computer Science" className="dark:bg-[#1f2937]">Computer Science</option>
                            <option value="Engineering" className="dark:bg-[#1f2937]">Engineering</option>
                            <option value="Business Administration" className="dark:bg-[#1f2937]">Business Administration</option>
                            <option value="Arts & Humanities" className="dark:bg-[#1f2937]">Arts & Humanities</option>
                            <option value="Sciences" className="dark:bg-[#1f2937]">Sciences</option>
                            <option value="Medicine" className="dark:bg-[#1f2937]">Medicine</option>
                        </select>
                ...
                <div className="md:col-span-2">
                    ...
                    <div className="relative group">
                        ...
                        <select
                            ...
                            style={{ colorScheme: 'dark' }}
                        >
                            <option value="" className="dark:bg-[#1f2937]">Select Year</option>
                            <option value="1st Year" className="dark:bg-[#1f2937]">1st Year</option>
                            <option value="2nd Year" className="dark:bg-[#1f2937]">2nd Year</option>
                            <option value="3rd Year" className="dark:bg-[#1f2937]">3rd Year</option>
                            <option value="4th Year" className="dark:bg-[#1f2937]">4th Year</option>
                            <option value="Graduate" className="dark:bg-[#1f2937]">Graduate</option>
                        </select>
                        <div className="absolute right-4 top-1/2 -translate-y-1/2 pointer-events-none text-gray-400 dark:text-white/30">
                            <Calendar className="w-4 h-4 rotate-90" />
                        </div>
